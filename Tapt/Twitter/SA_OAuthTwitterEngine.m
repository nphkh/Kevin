...
//	_consumer = [[OAConsumer alloc] initWithKey: self.consumerKey secret: self.consumerSecret];
    _consumer = [[OAConsumer alloc] initWithKey:self.consumerKey secret:self.consumerSecret realm:nil];
	return _consumer;
}
...
//	OAMutableURLRequest			*request = [[OAMutableURLRequest alloc] initWithURL: self.authorizeURL consumer: nil token: _requestToken realm: nil signatureProvider: nil];	
    ...
    OAMutableURLRequest *request=[[OAMutableURLRequest alloc]initWithURL:self.authorizeURL consumer:nil token:_requestToken callback:nil signatureProvider:nil];
...
//    OAMutableURLRequest	*request = [[OAMutableURLRequest alloc] initWithURL: url consumer: self.consumer token:token realm:nil signatureProvider: nil];
    ...
    OAMutableURLRequest *request=[[OAMutableURLRequest alloc]initWithURL: url  consumer:self.consumer token:token callback:nil signatureProvider:nil];
...
//    OAMutableURLRequest *theRequest-[OAMutableURLRequest all]
