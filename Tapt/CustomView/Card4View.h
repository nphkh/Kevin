...
@protocol Card4CustomDlegate <NSObject>
...
@interface Card4View : UIView

@property (strong,nonatomic) id<Card4CustomDlegate>delegate;

@property (strong, nonatomic) IBOutlet UIView *viewHeader;
@property (strong, nonatomic) IBOutlet UILabel *lblLogoPlace;
