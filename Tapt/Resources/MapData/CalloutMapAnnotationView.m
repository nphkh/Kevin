...
//	return self;
    ...
    if (self) {
        ...
        self.centerOffset = CGPointMake(0,-100);   //0 -35  //////   58
        self.frame = CGRectMake(0,0,260,85);     //280, 85 /// 285,85
        
        UIView *_contentView1 = [[[UIView alloc] initWithFrame:CGRectMake(25, -4, self.frame.size.width, self.frame.size.height - Arror_height)] autorelease];
        _contentView1.backgroundColor   = [UIColor clearColor];
        [self addSubview:_contentView1];
        _contentView = _contentView1;
