...
if([[[UIDevice currentDevice] systemVersion]floatValue]>=7.0)
{
        ...
        CGRect rect = [self.labelText boundingRectWithSize:CGSizeMake(300, CGFLOAT_MAX)
        ...
        if (nil != self.detailsLabelText) {
            ...
            NSDictionary *attributes = @{NSFontAttributeName: self.detailsLabelFont};
            
            CGRect rect = [self.detailsLabelText boundingRectWithSize:CGSizeMake(width, CGFLOAT_MAX)
                                                              options:NSStringDrawingUsesLineFragmentOrigin
                                                           attributes:attributes
                                                              context:nil];
            dims=rect.size;
